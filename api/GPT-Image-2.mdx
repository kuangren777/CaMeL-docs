...
在 [CaMeL AI 平台](https://camel.kr777.top/token) 注册并获取 API Key（格式：`sk-xxxxxx...`）。
...
<CodeGroup>
  ...
  const API_BASE = 'https://camel.kr777.top/v1';
  ...
  curl -X POST https://camel.kr777.top/v1/images/generations \
...
* **官网：** [https://camel.kr777.top](https://camel.kr777.top)
* **文档：** [https://camel.kr777.top/docs](https://camel.kr777.top/docs)
* **问题反馈：** 联系客服或提交工单
