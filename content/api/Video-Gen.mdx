...
curl @@API_BASE@@/videos/{video_id} \
  -H "Authorization: Bearer $CAMELAI_API_KEY"

# 第三步：下载视频
curl @@API_BASE@@/videos/{video_id}/content \
  -H "Authorization: Bearer $CAMELAI_API_KEY" \
  --output video.mp4
```
...
```json  theme={null}
{
  ...
  "width": 1920,
  "height": 1080,
  "url": "@@API_BASE@@/videos/eyJtb2RlbCI6IndhbjI.../content",
  "error": null
}
```
