...
* [gpt-4o-audio-preview](@@CONSOLE_BASE@@/model/gpt-4o-audio-preview) —— OpenAI 最新的音频生成模型，支持对话式音频生成
* [**gpt-4o-mini-tts**](@@CONSOLE_BASE@@/model/gpt-4o-mini-tts) —— 智能实时应用的首选模型，支持高级语音控制，可以通过提示词控制多种语音特性：
  1. 口音 (Accent)
  ...
  6. 语调 (Tone)
  7. 轻声说话 (Whispering)
* [**tts-1-hd**](@@CONSOLE_BASE@@/model/tts-1-hd)  —— 高清音质的上一代 TTS 模型
* [**tts-1**](@@CONSOLE_BASE@@/model/tts-1) —— 标准 TTS 模型，平衡质量和速度

### Gemini 模型

* [**gemini-2.5-flash-preview-tts**](@@CONSOLE_BASE@@/model/gemini-2.5-flash-preview-tts) —— Gemini 快速 TTS 模型，支持单说话人和多说话人音频生成
* [**gemini-2.5-pro-preview-tts**](@@CONSOLE_BASE@@/model/gemini-2.5-pro-preview-tts) —— Gemini 专业 TTS 模型，支持单说话人和多说话人音频生成
