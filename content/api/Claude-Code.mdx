...
1. 将`ANTHROPIC_BASE_URL` 设置为`@@API_BASE@@`
2. `ANTHROPIC_AUTH_TOKEN` 设置为从 [CaMeL AI 平台](@@CONSOLE_BASE@@/token) 获取的 API Key
3. `ANTHROPIC_MODEL`：设置为[模型列表](@@CONSOLE_BASE@@/models)中支持的模型。
...
<Tabs>
  <Tab title="macOS">
    ...
    <CodeGroup>
      ...
      echo 'export ANTHROPIC_BASE_URL="@@API_BASE@@"' >> ~/.zshrc
      ...
      # CAMELAI_API_KEY 替换为你从 CaMeL AI 平台获取的 Key
      echo 'export ANTHROPIC_BASE_URL="@@API_BASE@@"' >> ~/.bash_profile
  ...
  <Tab title="Windows">
    ...
    <Tabs>
      <Tab title="CMD">
        ...
        setx ANTHROPIC_BASE_URL "@@API_BASE@@"
      ...
      <Tab title="PowerShell">
        ...
        [Environment]::SetEnvironmentVariable("ANTHROPIC_BASE_URL", "@@API_BASE@@", [EnvironmentVariableTarget]::User)
